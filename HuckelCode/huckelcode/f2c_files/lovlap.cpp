...
extern double pow_di(real *ap, int *bp);

/* Table of constant values */

static real c_b3 = .5;

void lovlap(real *strad, real *a, real *b, real *sk1, real *sk2, real *r, int *l1,
                             int *l2,int *m1,int *n1,int *n2, int *max__)
{
    /* Initialized data */

    static real bincoe[64]        /* was [8][8] */ = { 1.,1.,1.,1.,1.,
    ...
    /* Local variables */
    static real fact[25];
    static int jend, kend;
    static real con12, rhoa, rhob, term;
    static int i, j, k;
    static real rhoab, terma, rhoap, value;
    static int maxxa, maxxb, maxxc;
    static real rhopo;
    static int i1, i2, i3, m2, i6, i5, i4;
    static real value1, value2, value3, value4;
    static int ip, ir, ju, ku, iab, ibb, icb, idb, ieb, iev;
    static real con1;
...
/*      write (*,*) 'Lovlap: ',sk1,sk2,r,l1,l2,m1,n1,n2,max */
    ...
    for (i = 2; i <= 25; ++i) {
/* L5: */
        fact[i - 1] = fact[i - 2] * (real) ((real) (i - 1));
    }
    m2 = *m1;
    *strad = 0.;
    rhoa = *r * *sk1;
    ...
    rhopo = rhoap * rhoab;
    i__1 = *l1 + *l2 + 1;
    terma = pow_di(&c_b3, &i__1) * std::sqrt((real) ((real) ((*l1 + *l1 + 1)
