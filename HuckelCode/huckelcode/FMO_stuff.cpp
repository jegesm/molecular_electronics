...
printmat(FMO_frag->eigenset.vectR,num_orbs,num_orbs,output_wf,1e-4,
details->wave_fn_PRT & PRT_TRANSPOSE_FLAG,num_orbs);
/********
  there's no need to print out imaginary components of the
  wavefunctions for molecular calculations.
********/
if( details->Execution_Mode != MOLECULAR ){
//fprintf(output_wf,";#\t***> IMAGINARY:\n");
printmat(FMO_frag->eigenset.vectI,num_orbs,num_orbs,output_wf,1e-4,
details->wave_fn_PRT & PRT_TRANSPOSE_FLAG,num_orbs);
}
}
