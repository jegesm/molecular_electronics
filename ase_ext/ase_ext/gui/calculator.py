...
from ase_ext.gui.progress import DefaultProgressIndicator, GpawProgressIndicator
from ase_ext.gui.widgets import pack, oops, cancel_apply_ok
...
class SetCalculator(SetupWindow):
    ...
    def ase_ext.mt_check(self):
        return self.element_check("ASE EMT", ['H', 'Al', 'Cu', 'Ag', 'Au',
                                              'Ni', 'Pd', 'Pt', 'C', 'N', 'O'])

    def choose_aseemt(self):
        self.gui.simulation["calc"] = ase_ext.EMT
        ase_ext.EMT.disabled = False  # In case Asap has been imported.
    ...
    def choose_aims(self):
        ...
        from ase_ext.calculators.aims import Aims
...
class AIMS_Window(gtk.Window):
    ...
    def __init__(self, owner, param, attrname):
        ...
        from ase_ext.calculators.aims import float_keys,exp_keys,string_keys,int_keys,bool_keys,list_keys,input_keys
        ...
        if save == gtk.RESPONSE_OK:
            ...
            while True:
                ...
                if "List of parameters used to initialize the calculator:" in line:
                    control.readline()
                    from ase_ext.io.aims import read_aims_calculator
    ...
    def expert_keyword_import(self, *args):
        ...
        if len(command) > 0 and command[0] in self.aims_keyword_list and not command[0] in self.aims_keyword_gui_list:
            ...
            oops("Don't know this keyword:" + command[0] 
                 ...
                 + "please add it to the top of ase_ext.calculators/aims.py.")
...
class VASP_Window(gtk.Window):
    ...
    def __init__(self, owner, param, attrname):
        ...
        from ase_ext.calculators.vasp import float_keys,exp_keys,string_keys,int_keys,bool_keys,list_keys,special_keys
    ...
    def export_vasp_files(self, *args):
        ...
        if save == gtk.RESPONSE_OK or save == gtk.RESPONSE_SAVE:
            ...
            from ase_ext.io.vasp import write_vasp
    ...
    def expert_keyword_import(self, *args):
        ...
        if len(command) > 0 and command[0] in self.vasp_keyword_list and not command[0] in self.vasp_keyword_gui_list:
            ...
            oops("Don't know this keyword: " + command[0] 
                 + "\nPlease check!\n\n" 
                 + "If you really think it should be available, "
                 + "please add it to the top of ase_ext.calculators/vasp.py.")
        self.expert_keyword_set.set_text("")
