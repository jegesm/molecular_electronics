...
py_template = """
from ase_ext.cluster import Cluster
import ase
...
# OPTIONAL: Cast to ase_ext.Atoms object, discarding extra information:
# atoms = ase_ext.Atoms(atoms)
"""
...
class SetupNanoparticle(SetupWindow):
    ...
    def __init__(self, gui):
        ...
        self.atoms = None
        import ase_ext.cluster.data
        self.data_module = ase_ext.cluster.data
        import ase_ext.cluster
        self.Cluster = ase_ext.cluster.Cluster
        self.wulffconstruction = ase_ext.cluster.wulff_construction
        self.no_update = True
    ...
    def make_layer_gui(self, box, data, method):
        ...
        # Get the surfaces in the order the ase_ext.cluster module expects
