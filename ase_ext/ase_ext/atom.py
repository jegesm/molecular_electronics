...
class Atom(object):
    ...
    __slots__ = ['_number', '_symbol', '_position', '_force', '_tag', '_momentum',
                 '_mass', '_magmom', '_charge', 'atoms', 'index']

    def __init__(self, symbol='X', position=(0, 0, 0), force=(0, 0, 0),
        ...
        if atoms is None:
            ...
            self._force = np.array(force, float)
            self._tag = tag
    ...
    def __repr__(self):
        ...
        for attr in ['tag', 'momentum', 'mass', 'magmom', 'charge', 'force']:
    ...
    def get_data(self):
        ...
        return (self.position, self.number,
                ...
                self.magmom, self.charge,self.force)
    ...
    def get_force(self): return self._get_copy('force')
    def _get_force(self): return self._get('force')
    ...
    def set_force(self, force):
        self._set('force', np.array(force, float))
    ...
    force = property(_get_force, set_force, doc='XYZ-forces')
