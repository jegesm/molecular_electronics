    ...
    def __init__(self,
        ...
        Valid kwargs:
          ...
          atoms : ASE.Atoms instance
            atoms is an ase_ext.Atoms object that will be attached
            to this calculator.
...
than density cutoff %i' % (pw, dw))
    ...
    def set_kpts(self, kpts):
        ...
        * cc162_1x1
        ...
        if isinstance(kpts, str):
            exec('from ase_ext.dft.kpoints import %s' % kpts)
        ...
        if np.array(kpts).shape == (3,):
            from ase_ext.dft.kpoints import monkhorst_pack
            N1, N2, N3 = kpts
    ...
    def calculation_required(self, atoms=None, quantities=None):
        ...
        quantities is here because of the ase_ext.interface.
        '''
