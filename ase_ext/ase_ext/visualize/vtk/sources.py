...
from ase_ext.data import covalent_radii as atomic_radii
from ase_ext.data.colors import jmol_colors as atomic_colors
#from ase_ext.data.colors import cpk_colors as atomic_colors
