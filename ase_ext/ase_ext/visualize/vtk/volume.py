...
from ase_ext.visualize.vtk.grid import vtkVolumeGrid
from ase_ext.visualize.vtk.module import vtkPolyDataModule
from ase_ext.visualize.vtk.pipeline import vtkSurfaceSmootherPipeline, \
